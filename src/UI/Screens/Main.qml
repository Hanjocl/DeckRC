...
ApplicationWindow {
    ...
    Image {
        id: backgroundImage
        anchors.fill: parent
        source: "src/UI/Assets/Images/Background.png" // Replace with your actual image path
        fillMode: Image.PreserveAspectCrop
        Accessible.name: "Background logo"
        Accessible.description: "Image of logo on the background"
    }
}
